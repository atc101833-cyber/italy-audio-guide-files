...
const V="italy-guide-v34",CORE=V+"-core",PREFIX="italy-guide-v29-city-";
const CORE_ASSETS=["./", "./index.html", "./itinerary-data.js", "./offline.html", "./manifest.json", "./cover.jpg", "./italy-pattern-background.jpg", "./player-skin-clean.png", "./milan.jpg", "./venice.jpg", "./florence.jpg", "./rome.jpg", "./offline-final-panel-v29.png"];
