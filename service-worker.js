...
const V="italy-guide-v18",CORE=V+"-core",PREFIX=V+"-city-";
const CORE_ASSETS=["./", "./index.html", "./offline.html", "./manifest.json", "./cover.jpg", "./italy-pattern-background.jpg", "./player-skin-clean.png", "./milan.jpg", "./venice.jpg", "./florence.jpg", "./rome.jpg", "./offline-final-panel-v18.png"];
